              ...
              <div className="space-y-6 lg:space-y-8">
                ...
                <div className="flex gap-4 flex-wrap pt-4">
                  <button
                    ...
                    className="bg-gradient-to-r from-cyan-600 to-cyan-700 text-white hover:from-cyan-700 hover:to-cyan-800 px-4 py-2.5 rounded-lg font-semibold text-sm shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 flex items-center gap-2"
                  >
                    <Play size={16} />
                  ...
                  <button
                    ...
                    className="border-2 border-white/30 hover:bg-white hover:text-cyan-950 text-white px-4 py-2.5 rounded-lg font-semibold text-sm backdrop-blur-sm transition-all duration-200 hover:shadow-lg"
                  >
                    Explore Program
                  </button>
                </div>

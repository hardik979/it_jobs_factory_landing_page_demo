  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col relative overflow-hidden">
        ...
        <section className="flex-grow mt-5 text-white pt-[120px] pb-24 px-4 sm:px-6 lg:px-10 relative z-10">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] items-start gap-12 lg:gap-16">
            ...
            <div className="space-y-8">
              {/* Badge */}
              <div className="flex items-center gap-3 bg-gradient-to-r from-white to-cyan-50 text-cyan-700 px-5 py-3 rounded-full shadow-lg w-fit text-sm font-semibold border border-white/20">
              ...
              <div className="space-y-4">
                ...
                <p className="text-base text-cyan-200 max-w-xl pt-2">
                  Be the first to know when our comprehensive Data Analytics
                  program launches. Learn Python, SQL, Excel, and Tableau to
                  solve real-world business problems and boost your career.
                </p>
                ...
                <div className="flex items-center gap-3 text-sm">
                  <div className="flex items-center gap-1 text-cyan-300">
                    <Users size={16} />
                    <span className="text-xs">Active community</span>
                  </div>
                </div>
              </div>
        ...
        {/* Section 2: Enhanced Stats Banner */}
        <section className="bg-gradient-to-r from-cyan-900 to-cyan-800 text-white border-t border-cyan-700/50 px-4 sm:px-6 lg:px-10 py-16 relative z-10">
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                {
                  label: "Learning Mode",
                  value: "Online Live Classes & Recorded Lectures",
                  icon: Globe,
                },
                {
                  label: "Next Cohort",
                ...
                <div key={i} className="text-center group">
                  <div className="p-3 bg-cyan-600/20 rounded-full w-fit mx-auto mb-4 group-hover:bg-cyan-600/30 transition-colors">
